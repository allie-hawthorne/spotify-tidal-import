...
export const Home = () => {
  ...
  const {onImportClick, succeededArtists, erroredArtists, succeededAlbums, erroredAlbums, succeededTracks, erroredTracks} = useEasyImport(importTracks, importAlbums, importArtists);
